...
export PURPLEFIN_COSIGN="${fake_cosign}"
export PURPLEFIN_COSIGN_RETRY_DELAY_SECONDS=0
export PURPLEFIN_COSIGN_SIGN_ATTEMPTS=2
export PURPLEFIN_COSIGN_VERIFY_ATTEMPTS=4
