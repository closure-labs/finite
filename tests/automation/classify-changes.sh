...
[[ "$(classify installer lib/render-profile-artifacts.nix)" == true ]]
[[ "$(classify installer modules/profiles/definitions.nix)" == true ]]
[[ "$(classify installer modules/sources/oci-locks.nix)" == true ]]
