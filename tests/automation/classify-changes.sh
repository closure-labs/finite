...
[[ "$(classify installer sources/fedora-bootc.json)" == true ]]
...
[[ "$(classify images .github/workflows/update-fedora-bootc.yml)" == false ]]
[[ "$(classify images sources/fedora-bootc.json)" == false ]]
