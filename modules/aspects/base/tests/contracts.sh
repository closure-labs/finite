...
espanso_input_rule="${rootfs}/usr/lib/udev/rules.d/70-finite-espanso-input.rules"
...
grep -qF 'ENV{ID_INPUT_KEYBOARD}=="1", TAG+="uaccess"' "${espanso_input_rule}"
