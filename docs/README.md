# Purplefin documentation

Start with the guide that matches what you want to accomplish.

## Use Purplefin

- [Install and update Purplefin](installation.md) on an existing bootc system
  or with the graphical installer.
- [Use Purplefin on a Dell XPS 13 9350](dell-xps-9350.md), including
  authentication, battery, display, power, and camera behavior.

## Build and customize Purplefin

- [Build and develop with Nix](development.md) using the pinned development
  shell, image applications, generated outputs, and repository checks.
