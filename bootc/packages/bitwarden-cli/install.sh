...
metadata_file="${PURPLEFIN_BITWARDEN_CLI_METADATA:-${build_root}/packages/bitwarden-cli/package.env}"
spec_file="${PURPLEFIN_BITWARDEN_CLI_SPEC:-${build_root}/packages/bitwarden-cli/package.spec}"
workdir="$(mktemp -d)"
rpm_build_packages=()
