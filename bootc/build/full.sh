...
profile_catalog="${build_root}/generated/profile-catalog.json"
...
# shellcheck source=/tmp/purplefin-build/lib/authselect-features.sh
source "${build_root}/lib/authselect-features.sh"
# shellcheck source=/tmp/purplefin-build/lib/hardware-security.sh
