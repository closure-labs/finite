...
profile_root="${build_root}/overlays/hardware/dell-xps-9350-intel/files"

# shellcheck source=/tmp/purplefin-build/lib/dell-xps-9350-common.sh
# shellcheck disable=SC1091
source "${build_root}/lib/dell-xps-9350-common.sh"
...
"${build_root}/overlays/hardware/dell-xps-9350-intel/build/install-libcamera-ov02c10-ipa.sh"
